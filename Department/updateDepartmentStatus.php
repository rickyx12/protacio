...
$dispensedNo = $ro->selectNow("trackingNo","value","name","dispensedNo");
...
$incrementDispensedNo = ($ro->selectNow("trackingNo","value","name","dispensedNo") + 1);
$ro->editNow("trackingNo","name","dispensedNo","value",$incrementDispensedNo);
$ro->editNow("patientCharges","itemNo",$remitted[$i],"dispensedNo",$dispensedNo);
/*
