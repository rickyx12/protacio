...
<?php   $ro->showFloorAsUpperMenu_admin($username,$module);          ?>
 ...
 <li>
                ...
                <ul>
 <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/graphicalReport/pieChart/selectShift_revenue.php?username=<?php echo $username; ?>&module=<?php echo $module; ?>" target="departmentX"><font color=red>Financial</font></a></li> 
 ...
 <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/graphicalReport/multipleLineChart/selectShift_phicReceivables.php?username=<?php echo $username; ?>&module=<?php echo $module; ?>" target="departmentX">Annual PhilHealth Receivables Chart</a></li> 
		...
		<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/graphicalReport/selectShift.php?username=<?php echo $username; ?>&switch=2" target="departmentX"><font color=red>Census</font></a></li>
