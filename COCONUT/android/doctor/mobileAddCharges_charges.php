...
xmlhttp.open("GET","searchAvailableChargesNow.php?room="+document.addCharge.room.value+"&username="+document.addCharge.username.value+"&batchNo="+document.addCharge.batchNo.value+"&registrationNo="+document.addCharge.registrationNo.value+"&charges="+document.addCharge.availableCharges.value,true);
xmlhttp.send();
}
</script>
...
echo "<input type='submit' style='background:#47a3da; border:0px; color:yellow; font-weight:bold; font-size:20px;' value='Charges'>";
$ro->coconutFormStop();
echo "</td>";
...
echo "<td>";
$ro->coconutFormStart("get","http://".$ro->getMyUrl()."/COCONUT/android/doctor/mobileAddCharges_medicine.php");
