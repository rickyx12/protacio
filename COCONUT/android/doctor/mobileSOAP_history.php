...
echo "<div style='background:#47a3da; margin:0 0 0 10px; height:540px; width:500px; border-radius:15px;'>";
echo "&nbsp;&nbsp;<Table border=0 width='100%' cellpadding=1>";
echo "<tr>";
echo "<td><b><i><font color='white'>".$ro->selectNow("patientCharges","description","itemNo",$itemNo)."</font></i></b></td>";
echo "<td align='right'><b><i><font color='white'>".$ro->selectNow("patientCharges","dateCharge","itemNo",$itemNo)."</font></i></b></td>";
echo "</tr>";
echo "</table>";
echo "<center>";
echo "<br>";
