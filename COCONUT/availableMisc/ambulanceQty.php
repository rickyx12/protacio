...
//addCharges.php
echo "<br><Br><Br><center><font color=blue>Ambulance</font>";
echo "<form method='get' action='http://".$ro->getMyUrl()."/COCONUT/availableMisc/addCharges_ambulance.php'>";
echo "<center><div style='border:1px solid #000000; width:400px; height:100px;	'>";
echo "<br><table border=0 cellpadding=0 cellspacing=0>";
echo "<tr>";
echo "<td><font size=3 color=red>Additional 10%?</font>&nbsp;&nbsp;</td>";
echo "<td>";
$ro->coconutComboBoxStart_short("additional");
