<?php
     ...
     */
    class revenueLineChart extends BarChart {
        /**
         ...
         */
        public function revenueLineChart($width = 600, $height = 250) {
            parent::BarChart($width, $height);

            $this->plot->setGraphPadding(new Padding(5, 30, 50, 70));
        }
        ...
        protected function printAxis() {
            ...
            for ($value = $minValue; $value <= $maxValue; $value += $stepValue) {
                ...
                $text->printText($img, $graphArea->x1 - 5, $y, $this->plot->getTextColor(), number_format($value * 1000,2) , $text->fontCondensed, $text->HORIZONTAL_RIGHT_ALIGN | $text->VERTICAL_CENTER_ALIGN);
            }
