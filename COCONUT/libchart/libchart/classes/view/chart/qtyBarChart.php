<?php
     ...
     */
    class qtyBarChart extends BarChart {
        /**
         ...
         */
        public function qtyBarChart($width = 600, $height = 250) {
            ...
            for ($j = 0; $j < $serieCount; $j++) {
                ...
                for ($i = 0; $i < $pointCount; $i++) {
                    ...
                    if ($this->config->getShowPointCaption()) {
                     $text->printText($img, $xmax + 5, $y2 - $barWidth / 2, $this->plot->getTextColor(),number_format($value*100), $text->fontCondensed, $text->VERTICAL_CENTER_ALIGN); //modified q e2 Aug 18,2012 4:24PM
                    }
