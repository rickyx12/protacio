<?php
    ...
    require_once 'view/chart/revenueBarChart.php'; //ito ung modified chart n gnwa n ricky dahil may BUG Aug 11,2012,4:19AM
    require_once 'view/chart/revenueLineChart.php';//modified chart for revenue/collection BUG FIXED Aug 11,2012, 3:46PM
    require_once 'view/chart/hundredsBarChart.php';//modified chart for best selling OPD BUG FIXED Aug 18,2012, 4:25PM
    require_once 'view/chart/qtyBarChart.php';//modified chart for best selling OPD BUG FIXED Aug 18,2012, 6:13PM
?>
