...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=3A E CART&branch=All&show=All" target='departmentX'>3A E CART</a></li>
 ...
 <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=OB PACKAGE&branch=All&show=All" target='departmentX'>OB PACKAGE</a></li>
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=OB PACKAGE&branch=All&show=search" target='departmentX'>OB PACKAGE</a></li>
