...
echo "<form method='get' action='collectionReport.php'>";
echo "<center><br><br><br><br><div style='border:1px solid #000000; width:500px; height:210px; border-color:black black black black;'>";
