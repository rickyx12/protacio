...
echo "<tr>";
echo "<td><font size=2><b> authorized representative: </b></font>
<br>
...
echo "
<Td> 
<input type='text' class='signature2' value='SAMUEL J. MENDERO'>
<br>
...
echo "
<Td> 
<input type='text' class='signature2' value='MEDICAL DIRECTOR'>
<br>
