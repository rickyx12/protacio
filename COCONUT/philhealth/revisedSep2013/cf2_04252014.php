...
<input type=text class='panz' maxlength=1 value=''><input type=text class='panz1' maxlength=1 value=''><input type=text class='panz1' maxlength=1 value=''><input type=text class='panz1' maxlength=1 value=''><input type=text class='panz1' maxlength=1 value=''><input type=text class='panz1' maxlength=1 value=''><input type=text class='panz1' maxlength=1 value=''><input type=text class='panz1' maxlength=1 value=''><input type=text class='panz1' maxlength=1 value=''>
</td>
</tr>


<tr>
<td><span class='style7'><font size=2><b>2.Name of Health Care Institution</b>:</font></span><input type='text' class='hospitalName' value='Mendero Medical Center '></td>
</tr>


<tr>
<td><span class='style7'><font size=2><b>3.Address</b>:</font></span> <input type='text' class='address' value='A.Tan St,'><input type='text' class='address' value=' Consolacion,'><input type='text' class='address' value='Cebu,'><input type='text' class='address' value='6001'> <br><span style='margin:0 0 0 100px;'><font size=1>Building No and Street Name</font></span><span style='margin:0 0 0 60px;'><font size=1>City/Municipality</font></span><span style='margin:0 0 0 120px;'><font size=1>Province</font></span><span style='margin:0 0 0 130px;'><font size=1>Zip Code</font></span>
