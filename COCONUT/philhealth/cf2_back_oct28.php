...
echo "<tr>";
echo "<Td width='40%'><u>MARIBETH B. SANDIG</u><Br><font size=2>Signature Over Printed Name of Authorized Representative
</font></td>";
echo "<td width='30%'><u>HOSPITAL ADMINISTRATOR</u><br><font size=2>Official Capacity / Designation
</font></tD>";
...
<br>
<input type=checkbox><font size=2>Spouse</font>&nbsp;&nbsp;<input type=checkbox><font size=2>Child</font>&nbsp;&nbsp;<input type=checkbox><font size=2>Parent</font>&nbsp;&nbsp;<input type=checkbox><font size=2>Guardian</font>
</td>";
echo "</tr>";
echo "</table>";
