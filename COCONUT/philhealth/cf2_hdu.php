...
echo "&nbsp;<input type='text' value='' class='dateAdmitted'>";
echo "</td>";
echo "<td width='32%'><font size=2>b.Time Admitted</font>&nbsp;&nbsp;";
echo "<input type='text' class='timeAdmitted' value=''>";
echo "</td>";
...
echo "<tr><td>&nbsp;<tr>";
echo "<tr>";
echo "<Td width='20%'><font size=2>c.Date Discharged</font>"; 
echo "<input type='text' class='dateAdmitted'>";
echo "</td>";
echo "<td width='10%'><font size=2>d.Time Discharged</font>";
echo "<input type='text' class='timeAdmitted'>";
echo "</td>";
