					...
					<div class="panel-body">
						<form class="form-horizontal" method="post" action="addSupplies1.php" role="form">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="description" class="form-control col-sm-10" value="<? echo $description ?>" autocomplete="off">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" name="sellingPrice" id="price" tabindex="-1" class="form-control col-sm-5" placeholder="Selling Price" autocomplete="off">
								</div>
							</div>
