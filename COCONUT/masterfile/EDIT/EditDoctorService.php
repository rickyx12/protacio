...
echo "<form method='get' action='editDoctorService1.php'>";
...
echo "<td><input type=text name='serviceName'  value='$serviceName' class='txtBox'></td>";
echo "</tr>";
echo "<tr>";
...
echo "<td><input type=text name='cashAmount' value='$cashAmount' class='shortField'></td>";
echo "</tr>";
echo "<tr>";
...
<option value='$companyRate'>$companyRate</option>
...
echo "<td><input type=text name='doctorShare' value='$doctorShare' class='shortField'>&nbsp;<font size=2>Ex:</font>&nbsp;&nbsp;<font size=2 color=red>.60 = 60%</font></td>";
echo "</tr>";
echo "</tr>";
echo "<tr>";
echo "<td><font class='labelz'>Discount&nbsp;</font></td>";
echo "<td><input type=text name='discount' value='$discount' class='shortField'>&nbsp;</td>";
echo "</tr>";
echo "<tr>";
echo "<td><font class='labelz'>Philhealth</font></tD>";
echo "<Td>";
$ro->coconutComboBoxStart_short("phic");
