...
xmlhttp.open("GET","searchCharges1.php?packageName="+document.addCharge.packageName.value+"&desc="+document.addCharge.availableCharges.value+"&packagePrice="+document.addCharge.packagePrice.value+"&phicPrice="+document.addCharge.phicPrice.value,true);
xmlhttp.send();
}
...
echo "<a href='http://".$ro->getMyUrl()."/COCONUT/hospitalPackage/searchInventory.php?packageName=$packageName&packagePrice=$packagePrice&phicPrice=$phicPrice' style='text-decoration:none;'><font color=red>Medicine / Supplies</font></a>";
