<?
	...
	$ro4->paid_invoices($date1,$date2,"Check");
			...
			$(document).ready(function(){
				...
				if( isChrome == true ) {
					$("#export").click(function(){
						...
						var reportName = '<? echo 'Check Paid Invoice ['.$ro4->formatDate($date1).' to '.$ro4->formatDate($date2).']' ?>';	
						/*
					...
					<tbody>
						<? foreach( $ro4->paid_invoices_controlNo() as $controlNo ) { ?>
							<tr>
								...
								<td>
									<?
										echo $ro->selectNow("vouchers","bank","controlNo",$controlNo)
									?>
								</td>
								<td>
									<?
										echo $ro->selectNow("vouchers","checkedNo","controlNo",$controlNo)
									?>
								</td>
								<td>
									<?
