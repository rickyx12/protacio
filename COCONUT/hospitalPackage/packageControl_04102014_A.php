...
public function searchInventory($desc,$packageName,$packagePrice,$phicPrice,$searchFrom) {
...
$result = mysql_query("SELECT description,inventoryCode,upper(inventoryType) as inventoryType,unitcost,Added,inventoryLocation from inventory where description like '$desc%%%%%%%%' and status not like 'DELETED_%%%%%%%' and inventoryLocation = '$searchFrom' order by description asc ");
