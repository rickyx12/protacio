...
public function searchItem($desc,$packageName) {
...
echo "<Td>&nbsp;&nbsp;<a href='/COCONUT/hospitalPackage/chargesQTY.php?desc=$row[Description]_$row[chargesCode]_$row[Category]&packageName=$packageName&unitcost=&Added=$row[WARD]'><font color=red>Add</font></a>&nbsp;&nbsp;</tD>";
echo "</tr>";
}
echo "</table>";
...
public function searchInventory($desc,$packageName,$searchFrom) {
...
echo "<tr>";
echo "<td>&nbsp;".$row['description']."</tD>";
echo "<td>&nbsp;".$row['inventoryLocation']."&nbsp;</tD>";

if( $row['inventoryType'] == "SUPPLIES" ) {
echo "<Td>&nbsp;&nbsp;<a href='/COCONUT/hospitalPackage/chargesQTY.php?desc=$row[description]_$row[inventoryCode]_$row[inventoryType]&packageName=$packageName&unitcost=$row[unitcost]&Added=$row[unitcost]'><font color=red>Add</font></a>&nbsp;&nbsp;</tD>";
}else {
echo "<Td>&nbsp;&nbsp;<a href='/COCONUT/hospitalPackage/chargesQTY.php?desc=$row[description]_$row[inventoryCode]_$row[inventoryType]&packageName=$packageName&unitcost=$row[unitcost]&Added=$row[opdPrice]'><font color=red>Add</font></a>&nbsp;&nbsp;</tD>";
echo "</tr>";
}
...
$this->showAddedPackage_total += $row['Added'];
...
$this->coconutTableData($row['Added']);
$this->coconutTableData("<a href='http://".$this->getMyUrl()."/COCONUT/hospitalPackage/editItem.php?packageName=$row[packageName]&packageIncluded_description=$row[packageIncluded_description]&packageIncluded_qty=$row[packageIncluded_qty]&added=$row[Added]&packageNo=$row[packageNo]'><img src='http://".$this->getMyUrl()."/COCONUT/myImages/pencil.jpeg'></a>");
...
$this->coconutTableRowStart();
$this->coconutTableData("&nbsp;<b><font size=2>TOTAL</font></b>");
$this->coconutTableData("&nbsp;");
$this->coconutTableData("&nbsp;".$this->showAddedPackage_total);
$this->coconutTableData("&nbsp;");
$this->coconutTableData("&nbsp;");
$this->coconutTableRowStop();
...
$this->coconutTableData("<a href='http://".$this->getMyUrl()."/COCONUT/hospitalPackage/searchInventory.php?packageName=$row[packageName]&packagePrice=$row[packagePrice]&phicPrice=$row[package_phicPrice]'><font size=2>Add New Items</font></a>");
$this->coconutTableRowStop();
  }
$this->coconutTableStop();
...
public $showAddedPackage_onPatient_total;
...
$this->coconutTableData("<a href='/COCONUT/hospitalPackage/onPatient/searchCharges.php?packageNo=$row[packageNo]&packageIncluded_description=$row[packageIncluded_description]'><font size=2 color=red>Zero Stock<br> [UPDATE]</font></a>");
}
...
$this->coconutTableData("&nbsp;");
$this->coconutTableData("&nbsp;");
$this->coconutTableData("&nbsp;".$this->showAddedPackage_onPatient_total);
$this->coconutTableRowStop();
$this->coconutTableStop();
echo "<br><br>";
...
public function searchReplaceItem($packageNo,$item,$inventoryLocation) {
