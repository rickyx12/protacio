...
xmlhttp.open("GET","searchCharges1.php?packageName="+document.addCharge.packageName.value+"&desc="+document.addCharge.availableCharges.value,true);
xmlhttp.send();
}
...
echo "<a href='http://".$ro->getMyUrl()."/COCONUT/hospitalPackage/searchInventory.php?packageName=$packageName' style='text-decoration:none;'><font color=red>Medicine / Supplies</font></a>";
