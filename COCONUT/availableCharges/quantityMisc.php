...
/* inalis ko dahil hindi na mkikita sa search kpag zero na ang quantity
...
//addCharges.php
echo "<br><Br><Br>";
echo "<form method='get' action='http://".$ro->getMyUrl()."/COCONUT/availableCharges/addCharges_misc.php'>";
