...
echo "<form method='get' action='summarizeCol.php'>";
echo "<input type=hidden name='username' value='$username'>";
echo "<input type=hidden name='status' value='$status'>";
echo "<input type=hidden name='reportName' value='$reportName'>";
echo "<br><br><Br><center><font size=1>$reportName Report</font><br><div style='border:1px solid #000000; width:500px; height:220px; border-color:black black black black;'>";
...
<td>Type</tD>
<td>
<select name='type' class='comboBoxShort'>
