...
echo "<form method='get' action='receiptTypeReportRedirect.php'>";
//echo "<input type=hidden name='username' value='$username'>";
echo "<input type=hidden name='receiptType' value='$receiptType'>";
echo "<input type=hidden name='username' value='$username'>";
echo "<center><br><br></font><br><div style='border:1px solid #000000; width:500px; height:210px; border-color:black black black black;'>";
