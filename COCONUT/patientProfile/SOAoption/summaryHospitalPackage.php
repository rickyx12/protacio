...
echo "</tr>";
echo "<tr>";
echo "<tD><font color=red>Package</font>:</tD>";
echo "<tD>&nbsp;".$ro->getRegistrationDetails_package()."</tD>";
echo "</tr>";
echo "</table>";
echo "<table border=0>";
echo "<td>Address:&nbsp;</tD>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company","MEDICINE",$registrationNo),0); echo"&nbsp;</td>";
...
echo "<td>&nbsp;</tD>";
echo "<td>&nbsp;</tD>";
echo "<td>&nbsp;<font color=red>".number_format("0.00" ,2)."</font>&nbsp;</tD>";
echo "</tr>";
