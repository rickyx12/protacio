...
if( $ro->selectNow("registrationDetails","prePackage","registrationNo",$registrationNo) != "" ) {
 $package = $ro->selectNow("registrationDetails","prePackage","registrationNo",$registrationNo); 
 $splitPackage = preg_split ("/\_/", $package); 

echo "<tr>";
echo "<Td>Package:&nbsp;".$splitPackage[0]."</td>";
echo "</tr>";
}else { }
...
$packageAmount = $splitPrePackage[1];
}else {
$packageAmount = $splitPrePackage[2];
}

echo "<tr>";
echo "<td>&nbsp;<a href='http://".$ro->getMyUrl()."/COCONUT/patientProfile/SOAoption/isPackageCash.php?registrationNo=$registrationNo&username=$username' style='text-decoration:none; color:black;'>".$splitPrePackage[0]."</a></tD>";
echo "<td>&nbsp;".$packageAmount."</tD>";
echo "<td>&nbsp;</tD>";
echo "<td>&nbsp;</tD>";
...
echo "<td>&nbsp;<b>".number_format($hospitalBill_gt + $pf_gt + $packageAmount,2)."</b>&nbsp;</tD>";
echo "<td>&nbsp;<b>".number_format($hospitalBill_phic + $pf_phic,2)."</b>&nbsp;</tD>";
echo "<td>&nbsp;<b>".number_format($hospitalBill_company + $pf_company ,2)."</b>&nbsp;</tD>";
//echo "<td>&nbsp;<b>".number_format($hospitalBill_phic + $pf_phic,2)."</b>&nbsp;</tD>";
if( $ro->selectNow("registrationDetails","isPackageCash","registrationNo",$registrationNo) == "yes" ) {
echo "<td>&nbsp;<b>".number_format($hospitalBill_cash + $pf_cash + $packageAmount ,2)."</b>&nbsp;</tD>";
}else {
...
echo "<td>&nbsp;</tD>";
if( $ro->selectNow("registrationDetails","isPackageCash","registrationNo",$registrationNo) == "yes" ) {
echo "<td>&nbsp;<b>".number_format(($gross - $ro->getRegistrationDetails_discount()  ) + $pf_cash + $packageAmount ,2)."</b>&nbsp;</tD>";
}else {
...
if( $ro->selectNow("registrationDetails","isPackageCash","registrationNo",$registrationNo) == "yes" ) {
$grandTotalz = ($gross - $ro->getRegistrationDetails_discount()  ) + $pf_cash + $packageAmount;
}else {
...
echo "<Tr>";
echo "<td>&nbsp;<font size=2><b>".$ro->descPartialPayment($registrationNo,$username)."</b></font></tD>";
echo "<td>&nbsp;</tD>";
echo "<td>&nbsp;</tD>";
echo "<td>&nbsp;</tD>";
