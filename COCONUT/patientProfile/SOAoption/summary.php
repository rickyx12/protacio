...
echo "<Td>Package:</td><td>&nbsp;".$splitPackage[1]." - ".$splitPackage[2]."</td>";
}else {
echo "<Td>Package:</td><td>&nbsp;".$splitPackage[1]." - ".$splitPackage[2]."</td>";
}
echo "</tr>";
...
echo "<td>&nbsp;<font color='white>'"; echo number_format($ro->getTotal("phic","Room And Board",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","MEDICINE",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","SUPPLIES",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","LABORATORY",$registrationNo),2); echo"</font>&nbsp;</td>";
...
if( $ro->getTotal("total","ULTRASOUND",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("total","ULTRASOUND",$registrationNo),2); echo"&nbsp;</td>";
$gt+=$ro->getTotal("total","ULTRASOUND",$registrationNo);
$hospitalBill_gt += $ro->getTotal("total","ULTRASOUND",$registrationNo);
}else {
echo "<td>&nbsp;</tD>";
}
   ...
   ///////////////// PHIC RADIOLOGY
if( $ro->getTotal("phic","ULTRASOUND",$registrationNo) > 0 ) {
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","ULTRASOUND",$registrationNo),2); echo"</font>&nbsp;</td>";
$phicz+=$ro->getTotal("phic","ULTRASOUND",$registrationNo);
$hospitalBill_phic += $ro->getTotal("phic","ULTRASOUND",$registrationNo);
}else {
echo "<td>&nbsp;</td>";
}
  ...
  //////// COMPANY RADIOLOGY
if( $ro->getTotal("company","ULTRASOUND",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company","ULTRASOUND",$registrationNo),2); echo"&nbsp;</td>";
$company+=$ro->getTotal("company","ULTRASOUND",$registrationNo);
$hospitalBill_company += $ro->getTotal("company","ULTRASOUND",$registrationNo);
}else {
echo "<td>&nbsp;</tD>";
}
...
if( $ro->getTotal("cashUnpaid","ULTRASOUND",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("cashUnpaid","ULTRASOUND",$registrationNo),2); echo"&nbsp;</td>";
$cashz += $ro->getTotal("cashUnpaid","ULTRASOUND",$registrationNo);
$hospitalBill_cash += $ro->getTotal("cashUnpaid","ULTRASOUND",$registrationNo);
}else {
echo "<td>&nbsp;</tD>";
}
echo "</tr>";
...
echo "<tr>";
echo "<td>&nbsp;X-RAY&nbsp;</td>";
if( $ro->getTotal("total","XRAY",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("total","XRAY",$registrationNo),2); echo"&nbsp;</td>";
$gt+=$ro->getTotal("total","XRAY",$registrationNo);
$hospitalBill_gt += $ro->getTotal("total","XRAY",$registrationNo);
}else {
echo "<td>&nbsp;</tD>";
}
   ...
   ///////////////// PHIC RADIOLOGY
if( $ro->getTotal("phic","XRAY",$registrationNo) > 0 ) {
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","XRAY",$registrationNo),2); echo"</font>&nbsp;</td>";
$phicz+=$ro->getTotal("phic","XRAY",$registrationNo);
$hospitalBill_phic += $ro->getTotal("phic","XRAY",$registrationNo);
}else {
echo "<td>&nbsp;</td>";
}
  ...
  //////// COMPANY RADIOLOGY
if( $ro->getTotal("company","XRAY",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company","XRAY",$registrationNo),2); echo"&nbsp;</td>";
$company+=$ro->getTotal("company","XRAY",$registrationNo);
$hospitalBill_company += $ro->getTotal("company","XRAY",$registrationNo);
}else {
echo "<td>&nbsp;</tD>";
}
...
if( $ro->getTotal("cashUnpaid","XRAY",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("cashUnpaid","XRAY",$registrationNo),2); echo"&nbsp;</td>";
$cashz += $ro->getTotal("cashUnpaid","XRAY",$registrationNo);
$hospitalBill_cash += $ro->getTotal("cashUnpaid","XRAY",$registrationNo);
}else {
echo "<td>&nbsp;</tD>";
}
echo "</tr>";
...
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","ECG",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","ENDOSCOPY",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","CARDIOLOGY",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","MISCELLANEOUS",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","OR/DR/ER FEE",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","REHAB",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","OXYGEN",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","NITROUS",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","CARDIAC",$registrationNo),2); echo "</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","BLOODBANK",$registrationNo),2); echo "</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","VENTILATOR",$registrationNo),2); echo "</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","PULSE_OXIMETER",$registrationNo),2); echo "</font>&nbsp;</td>";
