...
/*******************DISCOUNTED********************/
if( $ro->checkIfTitleExist_newDetailed($registrationNo,"PROFESSIONAL FEE") ) {
echo "<tr>";
...
$ro->newDetailed_discounted($registrationNo,"PROFESSIONAL FEE");
}else { }
/***************DISCOUNTED*********************/
...
if( $ro->selectNow("registrationDetails","discount","registrationNo",$registrationNo) != "" ) {
echo "<tr>";
echo "<Td>&nbsp;</td>";
echo "<Td>&nbsp;<font size=2>Hospital Bill Discount</font></td>";
echo "<Td>&nbsp;</td>";
echo "<Td>&nbsp;</td>";
echo "<Td>&nbsp;</td>";
echo "<Td>&nbsp;</td>";
echo "<Td>&nbsp;<font size=2>".number_format($ro->selectNow("registrationDetails","discount","registrationNo",$registrationNo),2)."</font></td>";
echo "<Td>&nbsp;</td>";
echo "<Td>&nbsp;</td>";
echo "</tr>";
...
echo "<td><font size=2><b>TOTAL</b></font></td>";
echo "<td><font size=1>=====></font></td>";
echo "<td>&nbsp;<font size=2><b>".number_format(($total - $ro->selectNow("registrationDetails","discount","registrationNo",$registrationNo) ),2)."</b></font></td>";
echo "<td>&nbsp;<font size=2><b>".number_format($phic,2)."</b></font></td>";
echo "<td>&nbsp;<font size=2><b>".number_format($company,2)."</b></font></td>";
echo "</tr>";
