...
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;</td>";
echo "<td><font size=2><b>".number_format($ro->detailedTotalOnly_inventory_totalCharges(),2)."</b></font></td>";
echo "</tr>";
...
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;</td>";
echo "<td><font size=2><b>".number_format( ($ro->detailedTotalOnly_inventory_totalCharges() + $ro->detailedTotalOnly_total()),2)."</b></font></td>";
echo "</tr>";
...
$HBtotal = ( $medicineTotal + $suppliesTotal + $laboratoryTotal + $ultrasoundTotal + $xrayTotal + $miscellaneousTotal + $orTotal + $roomTotal + $ctscanTotal + $spirometryTotal + $rehabTotal + $ecgTotal + $cardiacTotal + $erFeeTotal );
...
echo "<td></td>";
echo "<td></td>";
echo "<td>&nbsp;<font size=2><b>".number_format($HBtotal,2)."</b></font></td>";
echo "</tr>";
...
$total = ( $medicineTotal + $suppliesTotal + $laboratoryTotal + $ultrasoundTotal + $xrayTotal + $miscellaneousTotal + $orTotal + $roomTotal + $pfTotal + $ctscanTotal + $rehabTotal + $ecgTotal + $spirometryTotal + $erFeeTotal + $cardiacTotal);


$companyTotal = ( $medicineCompany + $suppliesCompany + $laboratoryCompany + $ultrasoundCompany + $xrayCompany + $miscellaneousCompany + $orCompany + $erFeeCompany + $roomCompany + $pfCompany + $ctscanCompany + $rehabCompany + $ecgCompany + $spirometryCompany + $cardiacCompany );

$cashTotal = ( $medicineCash + $suppliesCash + $laboratoryCash + $ultrasoundCash + $xrayCash + $miscellaneousCash + $orCash  + $roomCash + $pfCash + $ctscanCash + $rehabCash + $ecgCash + $spirometryCash + $erFeeCash + $cardiacCash );
...
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;".number_format($gtWithoutPHIC + $pfTotal,2)."</td>";
echo "<td>&nbsp;</td>";
echo "</tr>";
...
$firstCase_hospitalBill = number_format($ro->getTotal_No_pf("phic","",$registrationNo),2);
...
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;<font size=2>".number_format($totalCaseRate,2)."</font></td>";
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;</td>";
echo "</tr>";
...
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;<font size=2><b>".number_format($total - $totalCaseRate,2)."</b></font></td>";
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;</td>";
echo "</tr>";
...
$excessPF=$ro->selectNow("registrationDetails","excessPF","registrationNo",$registrationNo);
$excessRoom=$ro->selectNow("registrationDetails","excessRoom","registrationNo",$registrationNo);
$outStandingBill_company = (($companyTotal)-($excessMaxBenefits+$excessPF+$excessRoom));
...
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;<font size=2 class='doubleUnderline'><b>&nbsp;&nbsp;&nbsp;".number_format(($outStandingBill - $discount),2)."</b></font></td>";
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;</td>";
echo "</tr>";
...
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;<font size=2>".number_format($incrementalCost,2)."</font></td>";
echo "<td>&nbsp;<font size=2>".number_format($incrementalCost,2)."</font></td>";
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;</td>";
...
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;<font size=2><b>".number_format( (($ro->detailedTotalOnly_patientToPay_total() - $ro->detailedTotalOnly_deposit_total() + $incrementalCost + ($excessMaxBenefits+$excessPF+$excessRoom))),2)."</b></font></td>";
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;</td>";
echo "</tr>";
