...
$HBtotal = ( $medicineTotal + $suppliesTotal + $laboratoryTotal + $ultrasoundTotal + $xrayTotal + $miscellaneousTotal + $orTotal + $roomTotal + $ctscanTotal + $spirometryTotal + $rehabTotal + $ecgTotal + $cardiacTotal + $erFeeTotal + $dermaTotal );
...
$total = ( $medicineTotal + $suppliesTotal + $laboratoryTotal + $ultrasoundTotal + $xrayTotal + $miscellaneousTotal + $orTotal + $roomTotal + $pfTotal + $ctscanTotal + $rehabTotal + $ecgTotal + $spirometryTotal + $erFeeTotal + $cardiacTotal + $dermaTotal);


$companyTotal = ( $medicineCompany + $suppliesCompany + $laboratoryCompany + $ultrasoundCompany + $xrayCompany + $miscellaneousCompany + $orCompany + $erFeeCompany + $roomCompany + $pfCompany + $ctscanCompany + $rehabCompany + $ecgCompany + $spirometryCompany + $cardiacCompany + $dermaCompany );

$cashTotal = ( $medicineCash + $suppliesCash + $laboratoryCash + $ultrasoundCash + $xrayCash + $miscellaneousCash + $orCash  + $roomCash + $pfCash + $ctscanCash + $rehabCash + $ecgCash + $spirometryCash + $erFeeCash + $cardiacCash + $dermaCash );
