...
$HBtotal = ( $medicineTotal + $suppliesTotal + $laboratoryTotal + $ultrasoundTotal + $xrayTotal + $miscellaneousTotal + $orTotal + $roomTotal + $ctscanTotal + $rehabTotal );
...
$total = ( $medicineTotal + $suppliesTotal + $laboratoryTotal + $ultrasoundTotal + $xrayTotal + $miscellaneousTotal + $orTotal + $roomTotal + $pfTotal + $ctscanTotal + $rehabTotal);


$companyTotal = ( $medicineCompany + $suppliesCompany + $laboratoryCompany + $ultrasoundCompany + $xrayCompany + $miscellaneousCompany + $orCompany + $roomCompany + $pfCompany + $ctscanCompany + $rehabCompany );

$cashTotal = ( $medicineCash + $suppliesCash + $laboratoryCash + $ultrasoundCash + $xrayCash + $miscellaneousCash + $orCash + $roomCash + $pfCash + $ctscanCash + $rehabCash );
...
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;<font size=2><b>".number_format($gtWithoutPHIC + $pfTotal,2)."</b></font></td>";
echo "<td>&nbsp;</td>";
echo "</tr>";
...
$outStandingBill_company = (($companyTotal));
...
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;<font size=2><b>".number_format( (($ro->detailedTotalOnly_patientToPay_total() - $ro->detailedTotalOnly_deposit_total() + $incrementalCost)),2)."</b></font></td>";
echo "<td>&nbsp;</td>";
echo "<td>&nbsp;</td>";
echo "</tr>";
