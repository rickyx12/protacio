...
echo  "$('#tableHolder').load('detailedTotalOnly.php?registrationNo=$registrationNo&username=$username&show=$show&chargesCode=$chargesCode&showdate=$showdate', function(){";
