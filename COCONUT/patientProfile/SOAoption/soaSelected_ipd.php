...
echo  "<th>&nbsp;<font class='heading'><b>REQUESTED</b></font>&nbsp;</th>";
echo  "<th>&nbsp;<font class='heading'><b>DISPENSED</b></font>&nbsp;</th>";
...
echo "</tr>";
for($x=0;$x<$countz;$x++) {
$ro->chargesForSOA_showSelected_ipd($registrationNo,$itemNo[$x]);
}
echo "<tr>";
