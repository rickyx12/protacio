...
$ro->coconutTableRowStop();
$hb = ( $ro->selectNow("package","price","description",$ro->getRegistrationDetails_package()) - $ro->selectNow("package","pf","description",$ro->getRegistrationDetails_package()) );
$ro->coconutTableRowStart();
$ro->coconutTableData("<b>HOSPITAL BILL</b>");
$ro->coconutTableData("<b>".number_format($hb,2)."</b>");
$ro->coconutTableRowStop();


$ro->coconutTableRowStart();
$ro->coconutTableData("<b>PROFESSIONAL FEE</b>");
$ro->coconutTableData("<b>".number_format($ro->selectNow("package","pf","description",$ro->getRegistrationDetails_package()),2)."</b>");
$ro->coconutTableRowStop();
...
$ro->coconutHidden("hb",($hb - $totalPHIC ));
$ro->coconutHidden("pf",$ro->selectNow("package","pf","description",$ro->getRegistrationDetails_package()));
$ro->coconutComboBoxStart_long("doctor");
$ro->showOption_doubleWhere("patientCharges","description","registrationNo",$registrationNo,"title","PROFESSIONAL FEE");
...
$ro->coconutFormStart("get","consumePackage.php");
$ro->coconutHidden("registrationNo",$registrationNo);
$ro->coconutButton("Consume Package >>");
$ro->coconutFormStop();
