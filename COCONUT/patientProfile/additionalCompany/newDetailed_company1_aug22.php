...
$total = ( $medicine + $supplies + $laboratory + $radiology + $miscellaneous + $bloodBank + $ecg + $cardiology + $or_dr + $rehab + $oxygen + $nitrous + $dialysis + $nbs + $cardiac + $ventilator + $pulse_oximeter + $pf + $room );

$phic = ( $medicine_phic + $supplies_phic + $laboratory_phic + $radiology_phic + $miscellaneous_phic + $bloodBank_phic + $ecg_phic + $cardiology_phic + $or_dr_phic + $rehab_phic + $oxygen_phic + $nitrous_phic + $dialysis_phic + $nbs_phic + $cardiac_phic + $ventilator_phic + $pulse_oximeter_phic + $pf_phic + $room_phic );

$company = ( $medicine_company + $supplies_company + $laboratory_company + $radiology_company + $miscellaneous_company + $bloodBank_company + $ecg_company + $cardiology_company + $or_dr_company + $rehab_company + $oxygen_company + $nitrous_company + $dialysis_company + $nbs_company + $cardiac_company + $ventilator_company + $pulse_oximeter_company + $pf_company + $room_company );

$company1 = ( $medicine_company1 + $supplies_company1 + $laboratory_company1 + $radiology_company1 + $miscellaneous_company1 + $bloodBank_company1 + $ecg_company1 + $cardiology_company1 + $or_dr_company1 + $rehab_company1 + $oxygen_company1 + $nitrous_company1 + $dialysis_company1 + $nbs_company1 + $cardiac_company1 + $ventilator_company1 + $pulse_oximeter_company1 + $pf_company1 + $room_company1 );
