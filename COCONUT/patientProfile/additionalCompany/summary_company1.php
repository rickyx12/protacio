...
echo "<Td>Package:&nbsp;".$splitPackage[1]." - ".$splitPackage[2]."</td>";
}else {
echo "<Td>Package:&nbsp;".$splitPackage[1]." - ".$splitPackage[2]."</td>";
}
echo "</tr>";
...
echo "<th>&nbsp;Company&nbsp;</th>";
echo "<th>&nbsp;".$ro->selectNow("registrationDetails","company1","registrationNo",$registrationNo)."&nbsp;</th>";
echo "<th>&nbsp;Cash&nbsp;</th>";
echo "</tr>";
...
echo "<tD>&nbsp;</tD>";
 ...
 ////////COMPANY1 ROOM
if( $ro->getTotal("company1","Room And Board",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","Room And Board",$registrationNo),2); echo"&nbsp;</td>";
$company1+=$ro->getTotal("company1","Room And Board",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","Room And Board",$registrationNo);
}else {
echo "<tD>&nbsp;</tD>";
}
...
echo "<Td>&nbsp;</tD>";
    ...
    ////// COMPANY1 MEDICINE
if( $ro->getTotal("company1","MEDICINE",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","MEDICINE",$registrationNo),2); echo"&nbsp;</td>";
$company1+=$ro->getTotal("company1","MEDICINE",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","MEDICINE",$registrationNo);
}else {
echo "<Td>&nbsp;</tD>";
}
...
echo "<tD>&nbsp;</td>";
    ...
    ////// COMPANY1 SUPPLIES
if( $ro->getTotal("company1","SUPPLIES",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","SUPPLIES",$registrationNo),2); echo"&nbsp;</td>";
$company1+=$ro->getTotal("company1","SUPPLIES",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","SUPPLIES",$registrationNo);
}else {
echo "<tD>&nbsp;</td>";
}
...
echo "<Td>&nbsp;</tD>";
          ...
          ///// COMPANY1 LABORATORY
if( $ro->getTotal("company1","LABORATORY",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","LABORATORY",$registrationNo),2); echo"&nbsp;</td>";
$company1+=$ro->getTotal("company1","LABORATORY",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","LABORATORY",$registrationNo);
}else {
echo "<Td>&nbsp;</tD>";
}
...
echo "<td>&nbsp;</tD>";
  ...
  //////// COMPANY 1 RADIOLOGY
if( $ro->getTotal("company1","RADIOLOGY",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","RADIOLOGY",$registrationNo),2); echo"&nbsp;</td>";
$company1+=$ro->getTotal("company1","RADIOLOGY",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","RADIOLOGY",$registrationNo);
}else {
echo "<td>&nbsp;</tD>";
}
...
echo "<td>&nbsp;</tD>";
  ...
  //////// COMPANY 1 ECG
if( $ro->getTotal("company1","ECG",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","ECG",$registrationNo),2); echo"&nbsp;</td>";
$company1+=$ro->getTotal("company1","ECG",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","ECG",$registrationNo);
}else {
echo "<td>&nbsp;</tD>";
}
...
echo "<td>&nbsp;</tD>";
  ...
  //////// COMPANY 1 ENDOSCOPY
if( $ro->getTotal("company1","ENDOSCOPY",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","ENDOSCOPY",$registrationNo),2); echo"&nbsp;</td>";
$company1+=$ro->getTotal("company1","ENDOSCOPY",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","ENDOSCOPY",$registrationNo);
}else {
echo "<td>&nbsp;</tD>";
}
...
if( $ro->getTotal("company1","CARDIOLOGY",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","CARDIOLOGY",$registrationNo),2); echo"&nbsp;</td>";
$company1 += $ro->getTotal("company1","CARDIOLOGY",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","CARDIOLOGY",$registrationNo);
}else {
echo "<td>&nbsp;</tD>";
}
...
echo "<tD>&nbsp;</tD>";
      ...
      ////// COMPANY 1 MISCELLANEOUS
if( $ro->getTotal("company1","MISCELLANEOUS",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","MISCELLANEOUS",$registrationNo),2); echo"&nbsp;</td>";
$company1 += $ro->getTotal("company1","MISCELLANEOUS",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","MISCELLANEOUS",$registrationNo);
}else {
echo "<tD>&nbsp;</tD>";
}
...
echo "<tD>&nbsp;</tD>";
   ...
   ////// COMPANY 1 OR/DR/ER 
if( $ro->getTotal("company1","OR/DR/ER FEE",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","OR/DR/ER FEE",$registrationNo),2); echo"&nbsp;</td>";
$company1 +=$ro->getTotal("company1","OR/DR/ER FEE",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","OR/DR/ER FEE",$registrationNo);
}else {
echo "<tD>&nbsp;</tD>";
}
...
echo "<tD>&nbsp;</tD>";
    ...
    ///////////// COMPANY 1 REHAB
if( $ro->getTotal("company1","REHAB",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","REHAB",$registrationNo),2); echo"&nbsp;</td>";
$company1 += $ro->getTotal("company1","REHAB",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","REHAB",$registrationNo);
}else {
echo "<tD>&nbsp;</tD>";
}
...
echo "<tD>&nbsp;</tD>";
    ...
    ///////////// COMPANY 1 OXYGEN
if( $ro->getTotal("company1","OXYGEN",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","OXYGEN",$registrationNo),2); echo"&nbsp;</td>";

$company1+=$ro->getTotal("company1","OXYGEN",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","OXYGEN",$registrationNo);
}else {
echo "<tD>&nbsp;</tD>";
}
...
echo "<tD>&nbsp;</tD>";
    ...
    ///////////// COMPANY 1 OXYGEN
if( $ro->getTotal("company1","NITROUS",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","NITROUS",$registrationNo),2); echo"&nbsp;</td>";
$company1+=$ro->getTotal("company1","NITROUS",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","NITROUS",$registrationNo);
}else {
echo "<tD>&nbsp;</tD>";
}
...
echo "<tD>&nbsp;</tD>";
    ...
    ///////////// COMPANY 1 DIALYSIS
if( $ro->getTotal("company1","DIALYSIS",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","DIALYSIS",$registrationNo),2); echo"&nbsp;</td>";

$company1+=$ro->getTotal("company1","DIALYSIS",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","DIALYSIS",$registrationNo);
}else {
echo "<tD>&nbsp;</tD>";
}
...
echo "<tD>&nbsp;</tD>";
    ...
    ///////////// COMPANY 1 NBS
if( $ro->getTotal("company1","NBS",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","NBS",$registrationNo),2); echo"&nbsp;</td>";

$company1+=$ro->getTotal("company1","NBS",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","NBS",$registrationNo);
}else {
echo "<tD>&nbsp;</tD>";
}
...
echo "<tD>&nbsp;</tD>";
    ...
    ///////////// COMPANY NBS
if( $ro->getTotal("company1","CARDIAC",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","CARDIAC",$registrationNo),2); echo"&nbsp;</td>";

$company1+=$ro->getTotal("company1","CARDIAC",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","CARDIAC",$registrationNo);
}else {
echo "<tD>&nbsp;</tD>";
}
...
echo "<tD>&nbsp;</tD>";
    ...
    ///////////// COMPANY NBS
if( $ro->getTotal("company1","BLOODBANK",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","BLOODBANK",$registrationNo),2); echo"&nbsp;</td>";

$company1+=$ro->getTotal("company1","BLOODBANK",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","BLOODBANK",$registrationNo);
}else {
echo "<tD>&nbsp;</tD>";
}
...
echo "<tD>&nbsp;</tD>";
    ...
    ///////////// COMPANY 1 VENTILATOR
if( $ro->getTotal("company1","VENTILATOR",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","VENTILATOR",$registrationNo),2); echo"&nbsp;</td>";

$company1+=$ro->getTotal("company1","VENTILATOR",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","VENTILATOR",$registrationNo);
}else {
echo "<tD>&nbsp;</tD>";
}
...
echo "<tD>&nbsp;</tD>";
    ...
    ///////////// COMPANY PULSE_OXIMETER
if( $ro->getTotal("company1","PULSE_OXIMETER",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company1","PULSE_OXIMETER",$registrationNo),2); echo"&nbsp;</td>";

$company1+=$ro->getTotal("company1","PULSE_OXIMETER",$registrationNo);
$hospitalBill_company1 += $ro->getTotal("company1","PULSE_OXIMETER",$registrationNo);
}else {
echo "<tD>&nbsp;</tD>";
}
...
echo "<tD>&nbsp;<font size=3><b>".number_format($hospitalBill_company1,2)."</b></font></tD>";
...
echo "<tD>&nbsp;</tD>";
   ...
   ///////// COMPANY 1 PROFESSIONAL FEE
if( $ro->getTotal("company1","PROFESSIONAL FEE",$registrationNo) > 0 ) {
//echo "<td>&nbsp;"; echo number_format($ro->getTotal("company","PROFESSIONAL FEE",$registrationNo),0); echo"&nbsp;</td>";
$pf_company1+=$ro->getPatient_company1();
}else {
echo "<tD>&nbsp;</tD>";
}
...
$ro->getPatientDoc_company1($registrationNo);
...
echo "<td>&nbsp;<b>".number_format($hospitalBill_gt + $pf_gt + $splitPackage[2],2)."</b>&nbsp;</tD>";
echo "<td>&nbsp;<b>".number_format($hospitalBill_phic + $pf_phic,2)."</b>&nbsp;</tD>";

echo "<td>&nbsp;<b>".number_format($hospitalBill_company + $pf_company ,2)."</b>&nbsp;</tD>";
echo "<td>&nbsp;<b>".number_format($hospitalBill_company1 + $pf_company1 ,2)."</b>&nbsp;</tD>";
echo "<td>&nbsp;<b>".number_format($hospitalBill_cash + $pf_cash + $splitPackage[2] ,2)."</b>&nbsp;</tD>";
echo "</tr>";
...
echo "<td>&nbsp;</tD>";
echo "<td>&nbsp;</tD>";
echo "<td>&nbsp;<b>".number_format(($gross - $ro->getRegistrationDetails_discount()  ) + $pf_cash + $splitPackage[2] ,2)."</b>&nbsp;</tD>";
echo "</tr>";
...
echo "<Tr>";
echo "<td>&nbsp;<font size=2><b>".$ro->descPartialPayment_company1($registrationNo,$username)."</b></font></tD>";
echo "<td>&nbsp;</tD>";
echo "<td>&nbsp;</tD>";
echo "<td>&nbsp;</tD>";
echo "<td>&nbsp;</tD>";
...
if( $remainBalance > 0 ) {
echo "<td>&nbsp;<b>".number_format( $remainBalance + $splitPackage[2],2)."</b>&nbsp;</tD>";
}else {
