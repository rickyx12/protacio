...
echo "<iframe src='http://".$ro->getMyUrl()."/COCONUT/availableCharges/searchCharges.php?registrationNo=$registrationNo&username=$username&room=$room&batchNo=$batchNo' name='selectedFrame' width='100%' height='65%' style='border:1px solid #FF0000;' ></iframe>";

}

echo "<iframe src='showCart_update.php?registrationNo=$registrationNo&batchNo=$batchNo&username=$username' frameborder=0 width='100%'></iframe>";
