...
echo "|&nbsp;<a href='testDone.php'><span class='style2'>All Results</span></a>&nbsp;|&nbsp;<a href='testDone_lab.php'><span class='style1'>Laboratory</span></a>";
echo "&nbsp;|&nbsp;";
...
//echo "<a href='#'><span class='style2'>Set Alert</font></a>&nbsp;|";
echo "<br>";
...
echo "<th>Realesed</th>";
echo "</tr>";
$ro->listLaboratory_done("Mar","06",date("Y"));
echo "</table>";
