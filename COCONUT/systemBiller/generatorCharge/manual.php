...
$ro->coconutDesign();
$timeStart = preg_split ("/\:/", $ro->selectNow("generatorCharge","timeStart","dateStart",$date) ); 
$timeStop = preg_split ("/\:/", $ro->selectNow("generatorCharge","timeStop","dateStart",$date) ); 
echo "<Br><Br><BR>";
$ro->coconutFormStart("get","manual1.php");
...
echo "<td>Hours</td>";
echo "<td>";
$ro->coconutTextBox_short("hours", $ro->selectNow("generatorCharge","hours","dateStart",$date) );
echo "</td>";
echo "</tr>";
