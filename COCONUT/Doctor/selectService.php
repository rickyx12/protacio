...
echo "<option value='OPD PROCEDURE'>OPD PROCEDURE</option>";
echo "<option value='CO-MGMT'>CO-MGMT</option>";
echo "<option value='Clinic'>Clinic</option>";
echo "<option value='Insurance Coordinator'>Insurance Coordinator</option>";
echo "</select>";
