...
echo "<form method='get' action='genderCensusPie.php'>";
echo "<input type=hidden name='username' value='$username'>";
echo "<br><br><Br><br><center><div style='border:1px solid #000000; width:500px; height:81px; border-color:black black black black;'>";
