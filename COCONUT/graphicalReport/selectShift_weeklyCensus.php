...
echo "<form method='get' action='weeklyCensus.php'>";
echo "<br><br><Br><Br><br><br><center><font size=2 color=red>Weekly Registration</font><div style='border:1px solid #000000; width:500px; height:100px; border-color:black black black black;'>";
