		...
		<div class="container">
			...
			<div class="col-md-6">
				<table class="table table-hover">
					...
					<tbody>
						<? foreach( $ro3->phicPatient_registrationNo() as $registrationNo ) { ?>
							<tr>
								<td>
								...
								<td>
									<?
										$totalPHIC += $ro3->phicPatient_total($registrationNo);
										echo number_format($ro3->phicPatient_total($registrationNo),2);
									?>
								</td>
							</tr>
						<? } ?>
					...
					<tbody>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td><? echo number_format($totalPHIC,2) ?></td>
						</tr>
					</tbody>
				</table>
			</div>
