		...
		<div class="container">
			...
			<div class="col-md-6">
				<table class="table table-hover">
					...
					<tbody>
						<? foreach( $ro3->hmoPatient_registrationNo() as $registrationNo ) { ?>
							<tr>
								<td>
								...
								<td>
									<?
										$hmoTotal += $ro3->hmoPatient_total($registrationNo);
										echo number_format($ro3->hmoPatient_total($registrationNo),2);
					...
					<tbody>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td><? echo number_format($hmoTotal,2) ?></td>
						</tr>
					</tbody>
				</table>
			</div>
