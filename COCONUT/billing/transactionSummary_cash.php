...
<? $ro3->cashPaidPatient($date1,$date2) ?>
				...
				<table class="table table-hover">
					...
					<tbody>
						<? foreach( $ro3->cashPaidPatient_registrationNo() as $registrationNo ) { ?>
							<tr>
								...
								<td>
									<?
										$totalCash += $ro3->cashPaidPatient_total($registrationNo);
										echo number_format($ro3->cashPaidPatient_total($registrationNo),2);
									?>
								</td>
							</tr>
						<? } ?>
					...
					<tbody>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td><? echo number_format($totalCash,2) ?></td>
						</tr>
					</tbody>
				</table>
			</div>
