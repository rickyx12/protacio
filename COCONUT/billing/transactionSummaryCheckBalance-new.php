...
echo "<form method='post' action='inpatient-total-new.php' target='_blank'>";
$ro3->transactionSummaryDischarge($date,$date1);
echo "<Br><br>";

$ro4->inpatient_deposit($date,$date1,"Cash","yes");
$ro4->inpatient_deposit($date,$date1,"Credit Card","yes");
$deposit_cash = 0;
