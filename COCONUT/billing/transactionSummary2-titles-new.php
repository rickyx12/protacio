...
$ipd_deposit_less = $_GET['ipd_deposit_less'];
$ipd_deposit_total = ( $ipd_deposit_cash + $ipd_deposit_creditCard - $ipd_deposit_less );
					...
					<tbody>
						...
						<? if( $opd_rehab > 0 ) { ?>
							<tr>
								<td>Rehab</td>
								<td></td>
								<td><? ( $opd_rehab > 0 ) ? $x = number_format($opd_rehab,2) : $x = ""; echo $x ?></td>
							</tr>
						<? } ?>
					...
					<tbody>
						...
						<? //if( $ipd_deposit_total > 0 ) { ?>
							<tr>
								<td>Deposit</td>
								<td></td>
								<td><? ($ipd_deposit_total != '') ? $x = number_format($ipd_deposit_total,2) : $x = ""; echo $x; ?></td>
							</tr>
						<? //} ?>
