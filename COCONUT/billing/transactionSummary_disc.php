...
<? $ro3->discountedPatient($date1,$date2) ?>
		...
		<div class="container">
			...
			<div class="col-md-6">
				<table class="table table-hover">
					...
					<tbody>
						<? foreach( $ro3->discountedPatient_registrationNo() as $registrationNo ) { ?>
							<tr>
								<td>
								...
								<td>
									<?
										$totalDisc += $ro3->discountedPatient_total($registrationNo);
										echo number_format($ro3->discountedPatient_total($registrationNo),2)
									?>
								</td>
							</tr>
						<? } ?>
					...
					<tbody>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td><? echo number_format($totalDisc,2) ?></td>
						</tr>
					</tbody>
				</table>
			</div>
