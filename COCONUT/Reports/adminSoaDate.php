...
echo "<form method='get' action='adminSoa_handler.php'>";
echo "<center><br><br><br><br><br><br><Br><div style='border:1px solid #000000; width:500px; height:80px; border-color:black black black black;'>";
