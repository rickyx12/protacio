...
<form method="get" action="protacio-hmoSOA-ipd.php">
<br><br><center>
...
<td>&nbsp;<select name='month' class='comboBoxShort'>
...
<select name="day" class="comboBoxShort">
<?php 
...
<input type="text" class="shortField" name="year" value="<?php echo date('Y') ?>">
&nbsp;</td>
</tr>

<tr>
<td><font class='labelz'>To Date:</font></td>
<td>&nbsp;<select name='month1' class='comboBoxShort'>
<option value="01">Jan</option>
<option value="02">Feb</option>
<option value="03">Mar</option>
<option value="04">Apr</option>
...
<select name="day1" class="comboBoxShort">
<?php 
...
<input type="text" class="shortField" name="year1" value="<?php echo date('Y') ?>">
&nbsp;</td>
</tr>
<tr>
