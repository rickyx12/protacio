...
echo "<Br><br><br><br><Br>";
$ro->coconutFormStart("post","/COCONUT/Reports/Census/roomSegregated2.php");
...
echo "<td>Room</td>";
echo "<td>";
$ro->coconutComboBoxStart_long("roomType");
echo "<option>OB</option>";
echo "<option>GYNE</option>";
echo "<option>PEDIA</option>";
echo "<option>MALE MEDICAL</option>";
echo "<option>FEMALE MEDICAL</option>";
echo "<option>MALE SURGICAL</option>";
echo "<option>FEMALE SURGICAL</option>";
echo "<option>FS</option>";
echo "<option>ICU</option>";
echo "<option>NICU</option>";
echo "<option>LABOR</option>";
