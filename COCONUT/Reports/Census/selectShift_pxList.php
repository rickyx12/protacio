...
echo "<form method='get' action='pxList.php'>";
...
echo "</tr>";
echo "<tr>";
echo "<td>".$ro->coconutText("Type of Date")."</td>";
echo "<td>";
$ro->coconutComboBoxStart_long("dateType");
echo "<option value='dateRegistered'>Date Register</option>";
echo "<option value='dateUnregistered'>Date Discharged</option>";
