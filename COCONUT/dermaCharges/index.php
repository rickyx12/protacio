...
.style2 {font-family: Arial; font-size: 12px; font-weight: bold; color: #000000; }
...
echo "
      <tr>
        <td height='25'><div align='center'>&nbsp;<input name='Price' type='text' class='textfield01' placeholder='Price' />&nbsp;</div></td>
        <td height='25'><div align='center'>&nbsp;<input name='Capital' type='text' class='textfield01' placeholder='Unit Cost' />&nbsp;</div></td>
