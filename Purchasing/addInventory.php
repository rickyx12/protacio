...
echo "
        ...
        <tr>
          ...
          <td width='15' class='style2'><div align='center'>:</div></td>
          <td width='252' class='style2'><div align='left'>
            <input type=text class='textfield1' name='generic' value='$genericName' autocomplete='off' />
          </div></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width='15' class='style2'><div align='center'>:</div></td>
          <td width='252' class='style2'><div align='left'>
            <input type=text class='textfield1' name='fgquantity' autocomplete='off' value='0' />
          </div></td>
        </tr>
";
...
echo "
        ...
        <tr>
          ...
          <td width='15' class='style2'><div align='center'>:</div></td>
          <td width='252' class='style2'><div align='left'>
            <input type=text name='additional' class='textfield1' />
          </div></td>
        </tr>
        <tr>
          ...
          <td width='15' class='style2'><div align='center'>:</div></td>
          <td width='252' class='style2'><div align='left'>
            <input type=text name='ipdPrice' class='textfield1' />
          </div></td>
        </tr>
        <tr>
          ...
          <td width='15' class='style2'><div align='center'>:</div></td>
          <td width='252' class='style2'><div align='left'>
            <input type=text name='opdPrice' class='textfield1' />
          </div></td>
        </tr>
        <tr>
