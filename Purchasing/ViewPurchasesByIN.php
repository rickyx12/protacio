...
echo "
<br />
<div align='left' class='style4'>Invoice Number does not appear to be present. Try again!!!</div>
<META HTTP-EQUIV='Refresh'CONTENT='2;URL=ViewPurchasesSD.php?username=$username'>
";
}
else{
...
<META HTTP-EQUIV='Refresh'CONTENT='0;URL=CreatedReceivingReport.php?username=$username&sino=$sino&page=0'>
";
}
