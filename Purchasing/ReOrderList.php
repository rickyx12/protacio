...
<form name='Submit' method='get' action='CreatePurchaseOrder.php'>
  <tr>
    <td width='60%' bgcolor='#FFFFFF'><div align='left'>
      <table border='0' cellspacing='0' cellpadding='0'>
        <tr>
          <td><a href='ReOrderList.php?username=$username&show=Medicine&sort=$sort' class='$amed'><input type='button' name='Me' class='$buttonmed' value='     Medicine  ($zx)    ' /></a></td>
          <td><a href='ReOrderList.php?username=$username&show=Supplies&sort=$sort' class='$asup'><input type='button' name='Me' class='$buttonsup' value='     Supplies ($xx)     ' /></a></td>
        </tr>
      </table>
    </div></td>
    <td width='40%' bgcolor='#FFFFFF'><div align='right'>
      <input type='submit' name='ReOrder' class='button1' value='Re-Order Selected Items &gt;&gt;' />
    </div></td>
  </tr>
";
