...
echo "
<br />
<div align='left'><span class='style3'>Fill Up FIelds</span>
  <table width='400' border='1' bgcolor='#0066FF' cellpadding='0' cellspacing='0' bordercolor='#000000'>
...
$supsql=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT supplierCode, supplierName FROM supplier WHERE status='Active' ORDER BY supplierName");
