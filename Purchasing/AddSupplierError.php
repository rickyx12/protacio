...
<table width='400' border='1' bordercolor='#000000' cellspacing='0' cellpadding='0'>
  <tr><form name='edit' method='get' action='AddSupplierAuth.php'>
    <td bgcolor='#0066FF'><table width='400' border='0' cellspacing='0' cellpadding='0'>
      ...
      <tr>
        <td width='auto'><div align='left' class='style4'>&nbsp;Supplier Name</div></td>
        <td width='15'><div align='center' class='style4'>:</div></td>
        <td width='auto'><div align='left' class='style4'><input type='text' name='supplierName' class='textfield1' value='$supplierName' /></div></td>
      </tr>
      <tr>
        <td><div align='left' class='style4'>&nbsp;Contact Person</div></td>
        <td><div align='center' class='style4'>:</div></td>
        <td><div align='left' class='style4'><input type='text' name='contactPerson' class='textfield1' value='$contactPerson' /></div></td>
      </tr>
      <tr>
        <td><div align='left' class='style4'>&nbsp;Contact Number</div></td>
        <td><div align='center' class='style4'>:</div></td>
        <td><div align='left' class='style4'><input type='text' name='contactNo' class='textfield1' value='$contactNo' /></div></td>
      </tr>
      <tr>
        <td><div align='left' class='style4'>&nbsp;Address</div></td>
        <td><div align='center' class='style4'>:</div></td>
        <td><div align='left' class='style4'><textarea name='address' class='textfield1'>$address</textarea></div></td>
      </tr>
      <tr>
        <td><div align='left' class='style4'>&nbsp;Supplier Description</div></td>
        <td><div align='center' class='style4'>:</div></td>
        <td><div align='left' class='style4'><textarea name='description' class='textfield1'>$description</textarea></div></td>
      </tr>
";
...
echo "
      ...
      <tr>
        <td colspan='3' height='30'><div align='right' class='style6'><input type='submit' name='Edit' class='button1' value='Add' />&nbsp;</div></td>
      </tr>
    </table></td>
