...
echo "
    ...
    <tr>
      <td><div align='left'><span class='style6'>Are you sure you want to delete this </span><span class='style7'>$invoiceNo - $supplierName</span><span class='style6'>?</span></div></td>
    </tr>
    <tr>
      <td><div align='left'><table border='0' cellpadding='0' cellspacing='0'>
        <tr>
          <form name='No' method='get' action='CreatedReceivingReport.php'>
          <input name='username' type='hidden' value='$username' />
          <input name='sino' type='hidden' value='$sino' />
          <input name='page' type='hidden' value='0' />
          <td><input name='No' type='submit' class='button1' value='  No?   ' /></td>
          </form>
          <form name='No' method='get' action='DeleteReceivingReportThree.php'>
          <input name='username' type='hidden' value='$username' />
          <input name='sino' type='hidden' value='$sino' />
          <input name='page' type='hidden' value='0' />
          <input type='hidden' name='invoiceNo' value='$invoiceNo' />
          <input type='hidden' name='supplierName' value='$supplierName' />
          <td><input name='No' type='submit' class='button5' value='  Yes?  ' /></td>
          </form>
        </tr>
      </table></div></td>
    </tr>
