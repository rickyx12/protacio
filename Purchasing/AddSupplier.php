  ...
  <tr><form name='edit' method='get' action='AddSupplierAuth.php'>
    <td bgcolor='#0066FF'><table width='400' border='0' cellspacing='0' cellpadding='0'>
      ...
      <tr>
        ...
        <td width='auto'><div align='left' class='style4'><input type='text' name='supplierName' class='textfield1' value='' /></div></td>
      </tr>
      <tr>
        <td><div align='left' class='style4'>&nbsp;Contact Person</div></td>
        <td><div align='center' class='style4'>:</div></td>
        <td><div align='left' class='style4'><input type='text' name='contactPerson' class='textfield1' value='' /></div></td>
      </tr>
      <tr>
        <td><div align='left' class='style4'>&nbsp;Contact Number</div></td>
        <td><div align='center' class='style4'>:</div></td>
        <td><div align='left' class='style4'><input type='text' name='contactNo' class='textfield1' value='' /></div></td>
      </tr>
      <tr>
        <td><div align='left' class='style4'>&nbsp;Address</div></td>
        <td><div align='center' class='style4'>:</div></td>
        <td><div align='left' class='style4'><textarea name='address' class='textfield1'></textarea></div></td>
      </tr>
      <tr>
        <td><div align='left' class='style4'>&nbsp;Supplier Description</div></td>
        <td><div align='center' class='style4'>:</div></td>
        <td><div align='left' class='style4'><textarea name='description' class='textfield1'></textarea></div></td>
      </tr>
      <tr>
