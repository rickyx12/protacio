...
$month=date("m");
$year=date("Y");
//    <form id='View' name='Create' method='get' action='ViewPOPayables.php'>
echo "
<br />
<div align='left'>
  <table width='300' border='1' cellpadding='0' cellspacing='0' bordercolor='#000000' bgcolor='#0066FF'>
    <form id='View' name='Create' method='get' action='http://".$cuz->getMyUrl()."/COCONUT/purchasing/unpaidPO.php'>
    <input type='hidden' name='username' value='$username' />
    <tr>
      <td><table width='300' border='0' cellpadding='0' cellspacing='0'>
        <tr>
          <td colspan='3' height='30'><div class='style1' align='left'>&nbsp;Select Supplier</div></td>
        </tr>
        <tr>
...
echo "
        <tr>
          <td><div class='style2' align='left'>&nbsp;Date From</div></td>
