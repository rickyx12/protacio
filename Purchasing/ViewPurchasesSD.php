...
<div align='left'>
  <table width='400' border='1' cellpadding='0' cellspacing='0' bordercolor='#000000' bgcolor='#0066FF'>
    <form id='Create' name='Create' method='get' action='ViewPurchasesByIN.php'>
    <tr>
      <td><table width='400' border='0' cellpadding='0' cellspacing='0'>
        <tr>
          <td colspan='3' height='30'><div class='style1' align='left'>&nbsp;Search Invoice No.</div></td>
        </tr>
        <tr>
          <td width='110'><div class='style2' align='left'>&nbsp;Invoice Numeber</div></td>
          <td width='15'><div class='style2' align='center'>:</div></td>
          <td width='275'><div class='style2' align='left'>
            <input type='text' name='invoiceNo' class='textfield1' placeholder='Type Invoice No.' value='' />
          </div></td>
        </tr>
        <tr>
...
<br />
<br />
  <table width='250' border='1' cellpadding='0' cellspacing='0' bordercolor='#000000' bgcolor='#0066FF'>
    <form id='Create' name='Create' method='get' action='ViewPurchases.php'>
    <input type='hidden' name='username' value='$username' />
    <tr>
      <td><table width='250' border='0' cellpadding='0' cellspacing='0'>
        ...
        <tr>
          <td width='50'><div class='style2' align='left'>&nbsp;From</div></td>
          <td width='15'><div class='style2' align='center'>:</div></td>
...
echo "
        ...
        <tr>
          <td><div class='style2' align='left'>&nbsp;To</div></td>
