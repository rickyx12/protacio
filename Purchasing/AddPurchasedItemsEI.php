...
$timeAdded=$afetch['timeAdded'];
$inventoryLocation=$afetch['inventoryLocation'];
$inventoryType=$afetch['inventoryType'];
$inventoryCode=$afetch['inventoryCode'];
$branch=$afetch['branch'];
$transition=$afetch['transition'];
$remarks=$afetch['remarks'];
$preparation=$afetch['preparation'];
$phic=$afetch['phic'];
$pricing=$afetch['pricing'];
$criticalLevel=$afetch['criticalLevel'];
$supplier=$afetch['supplier'];
$phicPrice=$afetch['phicPrice'];
$companyPrice=$afetch['companyPrice'];
$autoDispense=$afetch['autoDispense'];
$fgQuantity=$afetch['fgQuantity'];
$ipdPrice=$afetch['ipdPrice'];
$opdPrice=$afetch['opdPrice'];
}

$dateAddedstr=strtotime($dateAdded);

$day=date("d",$dateAddedstr);
$month=date("m",$dateAddedstr);
$year=date("Y",$dateAddedstr);

echo "
<div align='left'>
  <table width='400' border='1' cellpadding='0' cellspacing='0' bordercolor='#000000' bgcolor='#000000'>
    <tr>
      <form method='post' action='AddPurchasedItemsEISave.php'>
...
echo "
        ...
        <tr>
          <td width='133' class='style2'><div align='left'>&nbsp;Generic</div></td>
          <td width='15' class='style2'><div align='center'>:</div></td>
          <td width='252' class='style2'><div align='left'>
            <input type=text class='textfield1' name='genericName' value='$genericName' autocomplete='off' />
          </div></td>
        </tr>
        <tr>
          <td width='133' class='style2'><div align='left'>&nbsp;Preparation</div></td>
          <td width='15' class='style2'><div align='center'>:</div></td>
          <td width='252' class='style2'><div align='left'>
            <input type=text class='textfield1' name='preparation' autocomplete='off' value='$preparation' />
          </div></td>
        </tr>
        <tr>
          ...
          <td width='15' class='style2'><div align='center'>:</div></td>
          <td width='252' class='style2'><div align='left'>
            <input type=text class='textfield1' name='unitcost' autocomplete='off' value='$unitcost' />
          </div></td>
        </tr>
        <tr>
          ...
          <td width='15' class='style2'><div align='center'>:</div></td>
          <td width='252' class='style2'><div align='left'>
            <input type=text class='textfield1' name='quantity' autocomplete='off' value='$quantity' />
          </div></td>
        </tr>
        <tr>
          ...
          <td width='15' class='style2'><div align='center'>:</div></td>
          <td width='252' class='style2'><div align='left'>
            <input type=text class='textfield1' name='fgquantity' autocomplete='off' value='$fgQuantity'  />
          </div></td>
        </tr>
";
...
echo "
              <option $opsel>$zinventoryLocation</option>
";
}
...
if($phic=='no'){$phicn="selected='selected'";$phicy="";}else if($phic=='yes'){$phicn="";$phicy="selected='selected'";}
        ...
        <tr>
          ...
          <td width='252' class='style2'><div align='left'>
            <select name='phic' class='textfield1'>
              <option value='no' $phicn>No</option>
              <option value='yes' $phicy>Yes</option>
            </select>
          </div></td>
        </tr>
        <tr>
          ...
          <td width='15' class='style2'><div align='center'>:</div></td>
          <td width='252' class='style2'><div align='left'>
            <input type=text name='additional' class='textfield1' value='$sellingPrice' />
          </div></td>
        </tr>
        <tr>
          <td width='133' class='style2'><div align='left'>&nbsp;IPD Price</div></td>
          <td width='15' class='style2'><div align='center'>:</div></td>
          <td width='252' class='style2'><div align='left'>
            <input type=text name='ipdPrice' class='textfield1' value='$ipdPrice' />
          </div></td>
        </tr>
        <tr>
          <td width='133' class='style2'><div align='left'>&nbsp;OPD Price</div></td>
          <td width='15' class='style2'><div align='center'>:</div></td>
          <td width='252' class='style2'><div align='left'>
            <input type=text name='opdPrice' class='textfield1' value='$opdPrice' />
          </div></td>
        </tr>
        <tr>
          ...
          <td width='15' class='style2'><div align='center'>:</div></td>
          <td width='252' class='style2'><div align='left'>
            <input type=text name='remarks' class='textfield1' value='$remarks' />
          </div></td>
        </tr>
        <tr>
          ...
          <td width='15' class='style2'><div align='center'>:</div></td>
          <td width='252' class='style2'><div align='left'>
            <input type=text name='criticalLevel' class='textfield1' value='$criticalLevel' />
          </div></td>
        </tr>
";

if($autoDispense=='no'){$adn="selected='selected'";$ady="";}else if($autoDispense=='yes'){$adn="";$ady="selected='selected'";}
        ...
        <tr>
          ...
          <td width='252' class='style2'><div align='left'>
            <select name='autoDispense' class='textfield1'>
              <option value='no' $adn>No</option>
              <option value='yes' $ady>Yes</option>
            </select>
          </div></td>
        </tr>
        <tr>
...
echo "
      ...
      <input type='hidden' name='genericName1' value='$genericName1' />
      <input type='hidden' name='classification' value='' />
      <input type=hidden name='inventoryType' value='medicine'>
      ...
      <input type=hidden name='pricing' value='sellingPrice'>
      ...
      <input type='hidden' name='stockCardNo' value='$stockCardNo' />
