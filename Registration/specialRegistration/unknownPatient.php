...
$ro->coconutHidden("manual_patientID","");
$ro->coconutHidden("manual_caseno","");
$ro->coconutHidden("pxCount","");
echo "<Br><Br><Br><Br><Br>";
...
echo "<td>";
$ro->coconutTextBox("lastname","Walk-in  ".$patientNo."_".$registrationNo);
echo "</td>";
echo "</tr>";
