...
$result = mysql_query("SELECT employeeID,username,password,module FROM registeredUser where username = '".mysql_real_escape_string($username)."' and password='".mysql_real_escape_string($password)."' and module = '".mysql_real_escape_string($module)."' ");
}
...
if( $module == "DOCTOR" ) {
$this->UserEmployeeID = $row['doctorCode'];
}else {
