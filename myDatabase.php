...
$result = mysqli_query($connection, " SELECT stockCardNo,description,genericName,encodedDetails,encodedBy,inventoryType from inventoryStockCard where (description like '$description%' or genericName like '$description%' or stockCardNo like '$description%') and status not like 'DELETED%' ") or die("Query fail: " . mysqli_error()); 
