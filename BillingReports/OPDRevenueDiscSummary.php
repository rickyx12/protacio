...
<table width='100%' border='0' cellspacing='0' cellpadding='0'>
  <tr>
    <td height='30'><div align='left' class='arial15blackbold'>OPD A/R - HMO/COMPANY SUMMARY</div></td>
  </tr>
  <tr>
...
$totalall+=(($totdiscount+$pfdiscount)+($totbalance+$error));
...
echo "
      <tr>
        ...
        <td class='table1Bottom'><a href='../COCONUT/patientProfile/SOAoption/newSOA/newDetailed.php?registrationNo=$registrationNo&username=$username&show=try' class='astyle' target='_blank'><div align='right' class='arial14black'>&nbsp;".number_format((($totdiscount+$pfdiscount)+($totbalance+$error)),2)."&nbsp;</div></a></td>
      </tr>
";
}
}
