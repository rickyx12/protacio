...
echo "
      <tr>
        ...
        <td class='table1Bottom'><a href='../COCONUT/patientProfile/SOAoption/newSOA/newDetailed.php?registrationNo=$registrationNo&username=$username&show=try' class='astyle' target='_blank'><div align='right' class='arial14black'>&nbsp;".number_format(($totcompany+$pfcompany),2)."&nbsp;</div></a></td>
      </tr>
";
}
}
