...
.buttonnodecor {font-family: Arial;font-size: 11px;border: 0;padding: 0;display: inline;background: none;color: #000000;}
-->
</style>
</head>
...
<table width='100%' border='0' cellspacing='0' cellpadding='0'>
  <tr>
    <td height='30'><div align='left' class='style3'>Transaction Summary</div></td>
  </tr>
  <tr>
...
echo "
          <tr>
            <td width='auto'><a href='OPDCreditCardSummary.php?username=$username&fyear=$fyear&fmonth=$fmonth&fday=$fday&tyear=$tyear&tmonth=$tmonth&tday=$tday&opdnum=$opdnum";

for($opcc=0;$opcc<=$opdnum;$opcc++){
$rnopccsel="rop".$opcc;
$rnopcc=$_POST[$rnopccsel];

echo "&".$rnopccsel."=$rnopcc";
}

echo "' class='astyle' target='_blank'><div align='left' class='style5'>CREDIT CARD</div></a></td>
...
echo "
          <tr>
            <td width='auto'><a href='OPDCashSummary.php?username=$username&fyear=$fyear&fmonth=$fmonth&fday=$fday&tyear=$tyear&tmonth=$tmonth&tday=$tday&opdnum=$opdnum";

for($opca=1;$opca<=$opdnum;$opca++){
$rnopcasel="rop".$opca;
$rnopca=$_POST[$rnopcasel];

echo "&".$rnopcasel."=$rnopca";
}

echo "' class='astyle' target='_blank'><div align='left' class='style5'>CASH</div></td>
...
echo "
          <tr>
            <td width='auto'><a href='OPDARPHICSummary.php?username=$username&fyear=$fyear&fmonth=$fmonth&fday=$fday&tyear=$tyear&tmonth=$tmonth&tday=$tday&opdnum=$opdnum";

for($opap=1;$opap<=$opdnum;$opap++){
$rnopapsel="rop".$opap;
$rnopap=$_POST[$rnopapsel];

echo "&".$rnopapsel."=$rnopap";
}

echo "' class='astyle' target='_blank'><div align='left' class='style5'>A/R - PHIC</div></a></td>
...
echo "
          <tr>
            <td width='auto'><a href='OPDARHMOSummary.php?username=$username&fyear=$fyear&fmonth=$fmonth&fday=$fday&tyear=$tyear&tmonth=$tmonth&tday=$tday&opdnum=$opdnum";

for($opah=1;$opah<=$opdnum;$opah++){
$rnopahsel="rop".$opah;
$rnopah=$_POST[$rnopahsel];

echo "&".$rnopahsel."=$rnopah";
}

echo "' class='astyle' target='_blank'><div align='left' class='style5'>A/R - HMO/COMPANY</div></td>
...
echo "
          <tr>
            <td width='auto'><a href='OPDRevenueDiscSummary.php?username=$username&fyear=$fyear&fmonth=$fmonth&fday=$fday&tyear=$tyear&tmonth=$tmonth&tday=$tday&opdnum=$opdnum";

for($oprd=1;$oprd<=$opdnum;$oprd++){
$rnoprdsel="rop".$oprd;
$rnoprd=$_POST[$rnoprdsel];

echo "&".$rnoprdsel."=$rnoprd";
}

echo "' class='astyle' target='_blank'><div align='left' class='style5'>REVENUE DISCOUNT</div></a></td>
...
echo "
          <tr>
            <td width='auto'><a href='OPDARPatientSummary.php?username=$username&fyear=$fyear&fmonth=$fmonth&fday=$fday&tyear=$tyear&tmonth=$tmonth&tday=$tday&opdnum=$opdnum";

for($oparp=1;$oparp<=$opdnum;$oparp++){
$rnoparpsel="rop".$oparp;
$rnoparp=$_POST[$rnoparpsel];

echo "&".$rnoparpsel."=$rnoparp";
}

echo "' class='astyle' target='_blank'><div align='left' class='style5'>A/R - PATIENT</div></a></td>
...
echo "
          <tr>
            <td width='auto'><a href='OPDClinicRevSummary.php?username=$username&fyear=$fyear&fmonth=$fmonth&fday=$fday&tyear=$tyear&tmonth=$tmonth&tday=$tday&opdnum=$opdnum";

for($opcr=1;$opcr<=$opdnum;$opcr++){
$rnopcrsel="rop".$opcr;
$rnopcr=$_POST[$rnopcrsel];

echo "&".$rnopcrsel."=$rnopcr";
}

echo "'' class='astyle' target='_blank'><div align='left' class='style5'>CLINIC REVENUE</div></a></td>
            <td width='auto'><div align='right' class='style5'></div></td>
...
echo "
          <tr>
            <td width='auto'><a href='OPDTitleSummary.php?username=$username&fyear=$fyear&fmonth=$fmonth&fday=$fday&tyear=$tyear&tmonth=$tmonth&tday=$tday&title=$xtitle&opdnum=$opdnum";
...
echo "'' class='astyle' target='_blank'><div align='left' class='style5'>".strtoupper($xtitle)."</div></a></td>
            <td width='auto'><div align='right' class='style5'></div></td>
...
if($dbalance!=0){
//echo $dregistrationNo."-".$ditemNo."-($dqsp)-($dtot)=".number_format($dbalance,2)." | OR No: $orNo | $ddateCharge"."<br />";
...
$zpaidDeposit=0;
$zsql=mysql_query("SELECT amountPaid, paidVia, paymentFor FROM patientPayment WHERE registrationNo='$dregistrationNo'");
...
$finalzamountPaidCashhb=$zamountPaidCashhb;
$finalzamountPaidCredithb=$zamountPaidCredithb;
$finalzamountPaidCashd=$zamountPaidCashd;
$finalzamountPaidCreditd=$zamountPaidCreditd;
...
if(($dtotamountPaidFromCreditCard+$epfamountPaidFromCreditCard)!=0){
echo "
          <tr>
            <td width='auto'><a href='IPDARCreditCardSummary.php?username=$username&fyear=$fyear&fmonth=$fmonth&fday=$fday&tyear=$tyear&tmonth=$tmonth&tday=$tday' class='astyle' target='_blank'><div align='left' class='style5'>A/R - CREDIT CARD</div></a></td>
            <td width='auto'><div align='right' class='style5'>".number_format(($dtotamountPaidFromCreditCard+$epfamountPaidFromCreditCard+$finalzamountPaidCredithb+$finalzamountPaidCreditd),2,'.',',')."</div></td>
            <td width='auto'><div align='right' class='style5'></div></td>
          </tr>
";
}
...
if(($dtotcashPaid+$epfcash+$finalzamountPaidCashhb+$finalzamountPaidCashd)!=0){
echo "
          <tr>
            <td width='auto'><a href='IPDCashSummary.php?username=$username&fyear=$fyear&fmonth=$fmonth&fday=$fday&tyear=$tyear&tmonth=$tmonth&tday=$tday' class='astyle' target='_blank'><div align='left' class='style5'>CASH</div></a></td>
            <td width='auto'><div align='right' class='style5'>".number_format(($dtotcashPaid+$epfcash+$finalzamountPaidCashhb+$finalzamountPaidCashd),2,'.',',')."</div></td>
            <td width='auto'><div align='ight' class='style5'></div></td>
          </tr>
";
}
...
echo "
          <tr>
            <td width='auto'><div align='left' class='style5'>A/R - PHIC</div></a></td>
...
echo "
          <tr>
            <td width='auto'><div align='left' class='style5'>A/R - HMO/COMPANY</div></td>
            <td width='auto'><div align='right' class='style5'>".number_format(($dtotcompany+$epfcompany),2,'.',',')."</div></td>
            <td width='auto'><div align='right' class='style5'></div></td>
          </tr>
";
}

if((($dtotdiscount+$epfdiscount)+($dtotbalance+$eerror))!=0){
echo "
          <tr>
            <td width='auto'><div align='left' class='style5'>REVENUE DISCOUNT</div></td>
            <td width='auto'><div align='right' class='style5'>".number_format((($dtotdiscount+$epfdiscount)+($dtotbalance+$eerror)),2,'.',',')."</div></td>
            <td width='auto'><div align='right' class='style5'></div></td>
          </tr>
";
}

if((($dtotcashUnpaid+$epfcashUnpaid)-($finalzamountPaidCashhb+$finalzamountPaidCredithb+$finalzamountPaidCashd+$finalzamountPaidCreditd))!=0){
echo "
          <tr>
            <td width='auto'><div align='left' class='style5'>A/R - PATIENT</div></td>
            <td width='auto'><div align='right' class='style5'>".number_format((($dtotcashUnpaid+$epfcashUnpaid)-($finalzamountPaidCashhb+$finalzamountPaidCredithb+$finalzamountPaidCashd+$finalzamountPaidCreditd)),2,'.',',')."</div></td>
            <td width='auto'><div align='right' class='style5'></div></td>
          </tr>
";
}
...
echo "
          <tr>
            <td width='auto'><div align='left' class='style5'>CLINIC REVENUE</div></td>
            <td width='auto'><div align='right' class='style5'></div></td>
            <td width='auto'><div align='right' class='style5'>".number_format($totPF,2,'.',',')."</div></td>
          </tr>
";
...
$gtotcredit=0;
$fsql=mysql_query("SELECT pc.title FROM patientCharges pc, registrationDetails rd WHERE pc.registrationNo=rd.registrationNo AND rd.type='IPD' AND pc.status NOT LIKE 'DELETED_%%%%' AND pc.title NOT LIKE 'PROFESSIONAL FEE' AND (pc.dateCharge BETWEEN '$fdate' AND '$tdate') GROUP BY pc.title ORDER BY pc.title");
while($ffetch=mysql_fetch_array($fsql)){
$ftitle=$ffetch['title'];

$gsql=mysql_query("SELECT SUM(sellingPrice*quantity) AS creditqsp, SUM(pc.discount) AS totcdiscount, SUM(pc.total) AS totctotal, SUM(pc.discount+pc.cashUnpaid+pc.cashPaid+pc.cashPaidFromBalance+pc.phic+pc.company+pc.amountPaidFromCreditCard) AS othertot FROM patientCharges pc, registrationDetails rd WHERE pc.registrationNo=rd.registrationNo AND rd.type='IPD' AND pc.status NOT LIKE 'DELETED_%%%%' AND pc.title='$ftitle' AND (pc.dateCharge BETWEEN '$fdate' AND '$tdate') ORDER BY pc.dateCharge,pc.timeCharge");
while($gfetch=mysql_fetch_array($gsql)){
$gtotcdiscount=$gfetch['totcdiscount'];
$gtotctotal=$gfetch['totctotal'];
$gothertot=$gfetch['othertot'];
$gcreditqsp=$gfetch['creditqsp'];
}
...
echo "
          <tr>
            <td width='auto'><div align='left' class='style5'>$ftitle</div></td>
            <td width='auto'><div align='right' class='style5'></div></td>
