...
if(($dtotamountPaidFromCreditCard+$epfamountPaidFromCreditCard+$finalzamountPaidCredithb+$finalzamountPaidCreditd)!=0){
echo "
          <tr>
...
echo "
          <tr>
            ...
            <td width='auto'><div align='right' class='style5'>".number_format((($dtotcashPaid+$epfcash+$finalzamountPaidCashhb+$finalzamountPaidCashd+$finalzamountPaidCredithb)-$finalztotgendisc),2,'.',',')."</div></td>
            <td width='auto'><div align='ight' class='style5'></div></td>
          </tr>
";
}
...
if((($dtotdiscount+$epfdiscount)+(round($dtotbalance)+$eerror))!=0){
echo "
          <tr>
...
echo "
            <td width='auto'><div align='left'><input type='submit' class='buttonnodecor' name='show' value='A/R - PATIENT' /></div></a></td>
            </form>
            <td width='auto'><div align='right' class='style5'>".number_format((($dtotcashUnpaid+$epfcashUnpaid)-($dtotamountPaidFromCreditCard+$epfamountPaidFromCreditCard+$finalzamountPaidCredithb+$finalzamountPaidCreditd+(($dtotcashPaid+$epfcash+$finalzamountPaidCashhb+$finalzamountPaidCashd+$finalzamountPaidCredithb)-$finalztotgendisc))),2,'.',',')."</div></td>
            <td width='auto'><div align='right' class='style5'></div></td>
          </tr>
";
}
