...
<table width='100%' border='0' cellspacing='0' cellpadding='0'>
  <tr>
    <td height='30'><div align='left' class='arial15blackbold'>IPD CLINIC REVENUE SUMMARY</div></td>
  </tr>
  <tr>
...
echo "
      <tr>
        ...
        <td class='table1Bottom'><a href='../COCONUT/patientProfile/SOAoption/newSOA/detailedTotalOnly_update.php?registrationNo=$registrationNo&username=$username&show=try&chargesCode=off&showdate=1' class='astyle' target='_blank'><div align='right' class='arial14black'>&nbsp;".number_format($totPF,2)."&nbsp;</div></a></td>
      </tr>
";
}
}
